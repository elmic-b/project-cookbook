 ...
 */
final class Version20210119090457 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE recipe_allergen (rec_all_id INT NOT NULL, fk_recipe_all INT DEFAULT NULL, fk_allergen_rec INT DEFAULT NULL, INDEX fk_recipe_all (fk_recipe_all), INDEX fk_allergen_rec (fk_allergen_rec), PRIMARY KEY(rec_all_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
